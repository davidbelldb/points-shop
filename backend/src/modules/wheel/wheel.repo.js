...
export async function updateWheel(id, patch) {
  ...
  for (const k of ['name','is_active','spin_label','peg_color','text_color','text_opacity','homepage_visible','homepage_title','homepage_subtitle','homepage_days','homepage_start_time','homepage_end_time']) {
