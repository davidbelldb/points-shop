...
//
// Ported verbatim from the Capacitor app's CrowWidget so the two render
// identically — same copy, same sprites, same ImperialBlack on parchment. The
// only difference is the deep link scheme, which has to open THIS app.
private let deepLink = URL(string: "sneakysocial://crow-tracker")
