...
function UpcomingCard({ ev }) {
  ...
  return (
    ...
    >
      <span
        className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-pink-100 shadow-sm"
      ...
      <div className="min-w-0 flex-1">
        ...
        {ev.location && (
          <p className="line-clamp-1 text-[10px] text-neutral-500">{ev.location}</p>
        )}
      </div>
